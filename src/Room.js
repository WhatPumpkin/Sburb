    ...
    Sburb.Room.prototype.getMoveFunction = function (sprite) {
        ...
        if (motionPath) {
            return function (ax, ay) {
                var fx, fy;
                fx =
                    ax * motionPath.xtox + ay * motionPath.ytox + motionPath.dx;
                fy =
                    ax * motionPath.xtoy + ay * motionPath.ytoy + motionPath.dy;
                return { x: fx, y: fy };
            };
        }
    };
    ...
    Sburb.Room.prototype.getInverseMoveFunction = function (sprite) {
        ...
        if (motionPath) {
            return function (ax, ay) {
                ...
                var fx, fy;
                var det =
                    motionPath.xtox * motionPath.ytoy -
                    motionPath.xtoy * motionPath.ytox;
                if (det) {
    ...
    Sburb.Room.prototype.serialize = function (output) {
        output = output.concat(
            "\n<room name='" +
                ...
                this.height +
                (this.walkableMap
                    ? "' walkableMap='" + this.walkableMap.name
                    : "") +
