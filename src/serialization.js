var Sburb = (function (Sburb) {
    ...
    Sburb.saveStateToStorage = function (description, auto, local) {
        description =
            typeof description !== "undefined" ? description : "SaveFile";
        ...
        compressed = Iuppiter.Base64.encode(
            Iuppiter.compress(serialized),
            true
        );
        var saveStateName =
            description +
